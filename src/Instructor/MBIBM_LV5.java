...
public class MBIBM_LV5 extends JFrame {
    JMenuBar menuBar;
    JPanel dataPanel;
    JPanel buttonPanel;
    JPanel secondPanel;
    ...
    public MBIBM_LV5() {
        ...
        btnResult.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                System.out.println("Level: Level-5/Year-II");
                System.out.println("----------------------------------------------------------------------------\n");
                System.out.println("MODULE ID        FULL MARKS       PASS MARKS         OBTAINED MARKS   \n");
                System.out.println("5FC003           100              50\t\t\t\t\t\t" + get1().getText().trim());
                System.out.println("5IB004           100              50\t\t\t\t\t\t" + get2().getText().trim());
                System.out.println("5IB005           100              50\t\t\t\t\t\t" + get3().getText().trim());
                System.out.println("5BU010           100              50\t\t\t\t\t\t" + get4().getText().trim());
                System.out.println("5BU012           100              50\t\t\t\t\t\t" + get5().getText().trim());
                System.out.println("5HR006           100              50\t\t\t\t\t\t" + get6().getText().trim());
                System.out.println("----------------------------------------------------------------------------\n");
                int i=40;
                if (m1< i ){
                    System.out.println(getStudentID().getText().trim()+": You have failed in 5FC003: International Financial Institutions and Market\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                }else if(m2<i){
                    System.out.println(getStudentID().getText().trim()+": You have failed in 5IB004: Economics of Managerial Decision-Making\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                }else if(m3<i){
                    System.out.println(getStudentID().getText().trim()+": You have failed in 5IB005: Contemporary Issues in IBM\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                }
                else if(m4<i){
                    System.out.println(getStudentID().getText().trim()+": You have failed in  5BU010: Digital Business and Innovation\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                }
                else if(m5<i){
                    System.out.println(getStudentID().getText().trim()+": You have failed in  5BU012: Operations and Supply Management\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                }
                else if(m6<i){
                    System.out.println(getStudentID().getText().trim()+": You have failed in  5HR006: International Human Resources – The Key Issues\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");

                }
                else{
                    System.out.println(getStudentID().getText().trim()+" : You have passed all the modules!");
                    System.out.println("Congratulation on passing Level-5/Year-II BIBM! and best of Luck for the next Level");
                }
                System.out.println("----------------------------------------------------------------------------------");
    ...
    private JPanel dataUI() {
        ...
        gbc.gridx = 0;
        gbc.gridy = 1;
        dataPanel.add(new JLabel("5FC003: International Financial Institutions and Market"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 2;
        dataPanel.add(new JLabel("5IB004: Economics of Managerial Decision-Making"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 3;
        dataPanel.add(new JLabel("5IB005: Contemporary Issues in IBM"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 4;
        dataPanel.add(new JLabel("5BU010: Digital Business and Innovation"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 5;
        dataPanel.add(new JLabel("5BU012: Operations and Supply Management"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 6;
        dataPanel.add(new JLabel("5HR006: International Human Resources – The Key Issues"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 7;
        ...
        try {
            ...
            while (resultSet.next()) {
                model.addRow(new Object[]{
                        ...
                        resultSet.getInt("5FC003"),
                        resultSet.getInt("5IB004"),
                        resultSet.getInt("5IB005"),
                        resultSet.getInt("5BU010"),
                        resultSet.getInt("5BU012"),
                        resultSet.getInt("5HR006"),
    ...
    private JPanel secondUI() {
        ...
        model.setColumnIdentifiers(new String[]{"Student ID", "5FC003", "5IB004", "5IB005","5BU010","5BU012","5HR006"});
