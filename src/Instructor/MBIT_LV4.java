...
public class MBIT_LV4 extends JFrame {
    JMenuBar menuBar;
    JPanel dataPanel;
    JPanel buttonPanel;
    JPanel secondPanel;
        ...
        btnResult.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int m6= Integer.parseInt(get6().getText().trim());
                    ...
                    System.out.println("4CI018           100              50\t\t\t\t\t\t" + get1().getText().trim());
                    System.out.println("4CS001           100              50\t\t\t\t\t\t" + get2().getText().trim());
                    System.out.println("4CS015           100              50\t\t\t\t\t\t" + get3().getText().trim());
                    System.out.println("4CS016           100              50\t\t\t\t\t\t" + get4().getText().trim());
                    System.out.println("4CS017           100              50\t\t\t\t\t\t" + get5().getText().trim());
                    System.out.println("4MM013           100              50\t\t\t\t\t\t" + get6().getText().trim());
                    System.out.println("----------------------------------------------------------------------------\n");
                    int i=40;
                    if (m1< i ){
                        System.out.println(getStudentID().getText().trim()+": You have failed in 4CI018: Academic Skills and Team Based Learning\n");
                        System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                    }else if(m2<i){
                            System.out.println(getStudentID().getText().trim()+": You have failed in 4CS001: Introductory Programming and Problem Solving\n");
                            System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                    }else if(m3<i){
                        System.out.println(getStudentID().getText().trim()+": You have failed in 4CS015: Fundamentals of Computing \n");
                        System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                    }
                    else if(m4<i){
                        System.out.println(getStudentID().getText().trim()+": You have failed in 4CS016: Embedded System Programming \n");
                        System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                    }
                    else if(m5<i){
                        System.out.println(getStudentID().getText().trim()+": You have failed in 4CS017: Internet Software Architecture \n");
                        System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                    }
                    else if(m6<i){
                        System.out.println(getStudentID().getText().trim()+": You have failed in 4MM013: Computational Mathematics \n");
                        System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");

                    }
                    else{
                        System.out.println(getStudentID().getText().trim()+" : You have passed all the modules!");
                        System.out.println("Congratulation on passing Level-4/Year-I BIT! and Best of Luck for next level!");
                    }
                System.out.println("----------------------------------------------------------------------------------");
    ...
    public void clear(){
        ...
        gbc.gridx = 0;
        gbc.gridy = 1;
        dataPanel.add(new JLabel("4CI018: Academic Skills and Team Based Learning"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 2;
        dataPanel.add(new JLabel("4CS001: Introductory Programming and Problem Solving"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 3;
        dataPanel.add(new JLabel("4CS015: Fundamentals of Computing"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 4;
        dataPanel.add(new JLabel("4CS016: Embedded System Programming"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 5;
        dataPanel.add(new JLabel("4CS017: Internet Software Architecture"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 6;
        dataPanel.add(new JLabel("4MM013: Computational Mathematics"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 7;
        ...
        try {
            ...
            while (resultSet.next()) {
                model.addRow(new Object[]{
                        ...
                        resultSet.getInt("4CI018"),
                        resultSet.getInt("4CS001"),
                        resultSet.getInt("4CS015"),
                        resultSet.getInt("4CS016"),
                        resultSet.getInt("4CS017"),
                        resultSet.getInt("4MM013"),
    ...
    private JPanel secondUI() {
        ...
        model.setColumnIdentifiers(new String[]{"Student ID", " 4CI018", "4CS001", "4CS015","4CS016","4CS017","4MM013"});
