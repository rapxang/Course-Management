...
public class MBIT_LV5 extends JFrame {
    JMenuBar menuBar;
    JPanel dataPanel;
    JPanel buttonPanel;
    JPanel secondPanel;
    ...
    public MBIT_LV5() {
        ...
        btnResult.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                System.out.println("5CS037           100              50\t\t\t\t\t\t" + get1().getText().trim());
                System.out.println("5CS019           100              50\t\t\t\t\t\t" + get2().getText().trim());
                System.out.println("5CS021           100              50\t\t\t\t\t\t" + get3().getText().trim());
                System.out.println("5CS022           100              50\t\t\t\t\t\t" + get4().getText().trim());
                System.out.println("5CS024           100              50\t\t\t\t\t\t" + get5().getText().trim());
                System.out.println("5CS020           100              50\t\t\t\t\t\t" + get6().getText().trim());
                System.out.println("----------------------------------------------------------------------------\n");
                int i=40;
                if (m1< i ){
                    System.out.println(getStudentID().getText().trim()+": You have failed in 5CS037: Concepts and Technologies of AI\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                }else if(m2<i){
                    System.out.println(getStudentID().getText().trim()+": You have failed in 5CS019: Object-Oriented Design and Programming\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                }else if(m3<i){
                    System.out.println(getStudentID().getText().trim()+": You have failed in 5CS021: Numerical Methods and Concurrency \n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                }
                else if(m4<i){
                    System.out.println(getStudentID().getText().trim()+": You have failed in  5CS022: Distributed and Cloud System Programming\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                }
                else if(m5<i){
                    System.out.println(getStudentID().getText().trim()+": You have failed in  5CS024: Collaborative Development\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                }
                else if(m6<i){
                    System.out.println(getStudentID().getText().trim()+": You have failed in  5CS020: Human Computer Interaction\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");

                }
                else{
                    System.out.println(getStudentID().getText().trim()+" : You have passed all the modules!");
                    System.out.println("Congratulation on passing Level-5/Year-II BIT! and Best of Luck for next level!");
                }
                System.out.println("----------------------------------------------------------------------------------");
    ...
    private JPanel dataUI() {
        ...
        gbc.gridx = 0;
        gbc.gridy = 1;
        dataPanel.add(new JLabel("5CS037: Concepts and Technologies of AI"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 2;
        dataPanel.add(new JLabel("5CS019: Object-Oriented Design and Programming"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 3;
        dataPanel.add(new JLabel("5CS021: Numerical Methods and Concurrency"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 4;
        dataPanel.add(new JLabel("5CS022: Distributed and Cloud System Programming"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 5;
        dataPanel.add(new JLabel("5CS024: Collaborative Development"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 6;
        dataPanel.add(new JLabel("5CS020: Human Computer Interaction"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 7;
        ...
        try {
            ...
            while (resultSet.next()) {
                model.addRow(new Object[]{
                        ...
                        resultSet.getInt("5CS037"),
                        resultSet.getInt("5CS019"),
                        resultSet.getInt("5CS021"),
                        resultSet.getInt("5CS022"),
                        resultSet.getInt("5CS024"),
                        resultSet.getInt("5CS020"),
    ...
    private JPanel secondUI() {
        ...
        model.setColumnIdentifiers(new String[]{"Student ID", "5CS037 ", "5CS019", "5CS021","5CS022","5CS024","5CS020"});
