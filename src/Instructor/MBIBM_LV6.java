...
public class MBIBM_LV6 extends JFrame {
    JMenuBar menuBar;
    JPanel dataPanel;
    JPanel buttonPanel;
    JPanel secondPanel;
    ...
    public MBIBM_LV6() {
        ...
        btnResult.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                System.out.println("Level: Level-3/Year-III");
                System.out.println("----------------------------------------------------------------------------\n");
                System.out.println("MODULE ID        FULL MARKS       PASS MARKS         OBTAINED MARKS   \n");
                System.out.println("6IB003           100              50\t\t\t\t\t\t" + get1().getText().trim());
                System.out.println("6IB006           100              50\t\t\t\t\t\t" + get2().getText().trim());
                System.out.println("6IB011           100              50\t\t\t\t\t\t" + get3().getText().trim());
                System.out.println("6MK001           100              50\t\t\t\t\t\t" + get4().getText().trim());
                System.out.println("6BE003           100              50\t\t\t\t\t\t" + get5().getText().trim());
                System.out.println("6BU013           100              50\t\t\t\t\t\t" + get6().getText().trim());
                System.out.println("----------------------------------------------------------------------------\n");
                int i=40;
                if (m1< i ){
                    System.out.println(getStudentID().getText().trim()+": You have failed in 6IB003: Dynamics of Multinational Companies\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                }else if(m2<i){
                    System.out.println(getStudentID().getText().trim()+": You have failed in 6IB006: Debating Globalisation\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                }else if(m3<i){
                    System.out.println(getStudentID().getText().trim()+": You have failed in 6IB011: Business Research Methods\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                }
                else if(m4<i){
                    System.out.println(getStudentID().getText().trim()+": You have failed in  6MK001: International Marketing\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                }
                else if(m5<i){
                    System.out.println(getStudentID().getText().trim()+": You have failed in  6BE003: Strategic Management\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");
                }
                else if(m6<i){
                    System.out.println(getStudentID().getText().trim()+": You have failed in  6BU013: Independent Project\n");
                    System.out.println("We Are Sorry to Announce that Your promotion to next level is Denied!");

                }
                else{
                    System.out.println(getStudentID().getText().trim()+" : You have passed all the modules!");
                    System.out.println("Congratulation on passing Level-6/Year-III BIBM!");
                    System.out.println("Congratulations on Your Graduation and Good Luck for Better Future!");
                }
                System.out.println("----------------------------------------------------------------------------------");
    ...
    private JPanel dataUI() {
        ...
        gbc.gridx = 0;
        gbc.gridy = 1;
        dataPanel.add(new JLabel("6IB003: Dynamics of Multinational Companies"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 2;
        dataPanel.add(new JLabel("6IB006: Debating Globalisation"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 3;
        dataPanel.add(new JLabel("6IB011: Business Research Methods"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 4;
        dataPanel.add(new JLabel("6MK001: International Marketing"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 5;
        dataPanel.add(new JLabel("6BE003: Strategic Management"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 6;
        dataPanel.add(new JLabel("6BU013: Independent Project"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 7;
        ...
        try {
            ...
            while (resultSet.next()) {
                model.addRow(new Object[]{
                        ...
                        resultSet.getInt("6IB003"),
                        resultSet.getInt("6IB006"),
                        resultSet.getInt("6IB011"),
                        resultSet.getInt("6MK001"),
                        resultSet.getInt("6BE003"),
                        resultSet.getInt("6BU013"),
    ...
    private JPanel secondUI() {
        ...
        model.setColumnIdentifiers(new String[]{"Student ID", "6IB003", "6IB006", "6IB011","6MK001","6BE003","6BU013"});
