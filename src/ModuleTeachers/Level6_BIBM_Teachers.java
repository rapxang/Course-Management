...
public class Level6_BIBM_Teachers extends JFrame {
    JPanel buttonPanel;
    ...
    private JPanel dataUI() {
        ...
        gbc.gridx = 0;
        gbc.gridy = 1;
        dataPanel.add(new JLabel("6BE003:"), gbc);
        gbc.gridx = 1;
        gbc.gridy = 1;
        dataPanel.add(new JLabel("Strategic Management"), gbc);
        gbc.gridx = 2;
        gbc.gridy = 1;
        dataPanel.add(new JLabel("Mr.Hemanta Gautam"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 2;
        dataPanel.add(new JLabel("6BU013:"), gbc);
        gbc.gridx = 1;
        gbc.gridy = 2;
        dataPanel.add(new JLabel("Independent Project"), gbc);
        gbc.gridx = 2;
        gbc.gridy = 2;
        dataPanel.add(new JLabel("Mr.Prakash Gautam"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 3;
        dataPanel.add(new JLabel("3BU002:"), gbc);
        gbc.gridx = 1;
        gbc.gridy = 3;
        dataPanel.add(new JLabel("21st Century Management"), gbc);
        gbc.gridx = 2;
        gbc.gridy = 3;
        dataPanel.add(new JLabel("Mrs.Rinu Tamang"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 4;
        dataPanel.add(new JLabel("3GK013:"), gbc);
        gbc.gridx = 1;
        gbc.gridy = 4;
        dataPanel.add(new JLabel("Project-Based Learning"), gbc);
        gbc.gridx = 2;
        gbc.gridy = 4;
        dataPanel.add(new JLabel("Mrs.Sita Tamang"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 5;
        dataPanel.add(new JLabel("6IB003:"), gbc);
        gbc.gridx = 1;
        gbc.gridy = 5;
        dataPanel.add(new JLabel("Dynamics of Multinational Companies"), gbc);
        gbc.gridx = 2;
        gbc.gridy = 5;
        dataPanel.add(new JLabel("Mrs.Manju Lama"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 6;
        dataPanel.add(new JLabel("6IB006:"), gbc);
        gbc.gridx = 1;
        gbc.gridy = 6;
        dataPanel.add(new JLabel("Debating Globalisation"), gbc);
        gbc.gridx = 2;
        gbc.gridy = 6;
        dataPanel.add(new JLabel("Mr.Deepson Shrestha"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 7;
        dataPanel.add(new JLabel("6IB011:"), gbc);
        gbc.gridx = 1;
        gbc.gridy = 7;
        dataPanel.add(new JLabel("Business Research Methods"), gbc);
        gbc.gridx = 2;
        gbc.gridy = 7;
        dataPanel.add(new JLabel("Mr.Sachin Kafley"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 8;
        dataPanel.add(new JLabel("6MK001:"), gbc);
        gbc.gridx = 1;
        gbc.gridy = 8;
        dataPanel.add(new JLabel("International Marketing"), gbc);
        gbc.gridx = 2;
        gbc.gridy = 8;
