...
public class Level5_BIT extends JFrame {
    JMenuBar menuBar;
    JPanel dataPanel;
    JPanel buttonPanel;
    JPanel secondPanel;
    ...
    public Level5_BIT() {
        ...
        subpanel2.add(CourseLv5BIT_Sem1());
        subpanel2.add(CourseLv5BIT_Sem2());
    ...
    private JPanel CourseLv5BIT_Sem1(){
        dataPanel=new JPanel();
        dataPanel.setLayout(new GridBagLayout());
        dataPanel.setBorder(BorderFactory.createTitledBorder("Courses to study in Level 5/Year 2:BIT:SEM-1"));
    ...
    private JPanel CourseLv5BIT_Sem2(){
        dataPanel=new JPanel();
        dataPanel.setLayout(new GridBagLayout());
        dataPanel.setBorder(BorderFactory.createTitledBorder("Courses to study in Level 5/Year 2:BIT:SEM-2"));
    ...
    private JPanel Show() {
        ...
        btnShow.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Level5_BIT_Teachers teacher=new Level5_BIT_Teachers();
        ...
        btnEnroll.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (first_name.isEmpty() || second_name.isEmpty() || phone_number.isEmpty() || address.isEmpty()) {
                    ...
                    lv5_enr.enroll(first_name,second_name,phone_number,address);
                    refreshTable();
