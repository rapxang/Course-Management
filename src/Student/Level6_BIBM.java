...
public class Level6_BIBM extends JFrame {
    JMenuBar menuBar;
    JPanel dataPanel;
    JPanel buttonPanel;
    JPanel secondPanel;
    ...
    public Level6_BIBM() {
        ...
        subpanel2.add(CourseLv6BIBM_Sem1());
        subpanel2.add(CourseLv6BIBM_Sem2());
    ...
    private void refreshTable() {
        ...
        model.setRowCount(0);
        try {
            ResultSet resultSet = lv6_enr.get();
    ...
    private JPanel CourseLv6BIBM_Sem1() {
        dataPanel = new JPanel();
        dataPanel.setLayout(new GridBagLayout());
        dataPanel.setBorder(BorderFactory.createTitledBorder("Courses to study in Level 5/Year 2:BIBM:SEM-1"));
        ...
        String[] courseList = new String[]{"6IB011: Business Research Methods", "6MK001: International Marketing"};
    ...
    private JPanel CourseLv6BIBM_Sem2() {
        dataPanel = new JPanel();
        dataPanel.setLayout(new GridBagLayout());
        dataPanel.setBorder(BorderFactory.createTitledBorder("Courses to study in Level 5/Year 2:BIBM:SEM-2"));
        ...
        String[] courseList = new String[]{"3BU002: 21st Century Management", "3GK013: Project-Based Learning"};
        JComboBox<String> course_select = new JComboBox<>(courseList);
        course.gridx = 0;
        course.gridy = 2;
        dataPanel.add(new JComboBox<String>(courseList), course);
    ...
    private JPanel Show() {
        ...
        btnShow.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Level6_BIBM_Teachers teacher = new Level6_BIBM_Teachers();
        ...
        btnEnroll.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (first_name.isEmpty() || second_name.isEmpty() || phone_number.isEmpty() || address.isEmpty()) {
                    ...
                    lv6_enr.enroll(first_name, second_name, phone_number, address);
                    refreshTable();
