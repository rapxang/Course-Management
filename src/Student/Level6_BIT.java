package Student;
import ModuleTeachers.Level6_BIT_Teachers;
import ModuleStudents.Student_BIT_lv6;
import javax.swing.*;
...
public class Level6_BIT extends JFrame {
    JMenuBar menuBar;
    JPanel dataPanel;
    JPanel buttonPanel;
    JPanel secondPanel;
    ...
    JTable table;
    JTextField txtName, txtSname, txtPhone, txtAddress, txtSelectedCourse;
    ButtonGroup bgGroup;
    JButton btnEnroll,btnShow;
    Student_BIT_lv6 st_enr;
    ...
    private JPanel CourseLv6BIT() {
        ...
        dataPanel.setBorder(BorderFactory.createTitledBorder("Courses in Level 6/Year 3:BIT:SEM-1"));
        ...
        course.gridx = 0;
        course.gridy = 1;
        dataPanel.add(new JLabel("6CS030: Big Data-Part1"), course);
        String[] courseList = new String[]{"6CS005: High Performance Computing", "6CS012: Artificial Intelligence and Machine Learning"};
        JComboBox<String> course_select = new JComboBox<>(courseList);
        course.gridx = 0;
        course.gridy = 2;
        dataPanel.add(new JComboBox<String>(courseList), course);
        return dataPanel;
    }
    ...
    private JPanel lv6() {
        dataPanel = new JPanel();
        dataPanel.setLayout(new GridBagLayout());
        dataPanel.setBorder(BorderFactory.createTitledBorder("Courses in Level 6/Year 3:BIT:SEM-2"));
        ...
        course.gridx = 0;
        course.gridy = 1;
        dataPanel.add(new JLabel("6CS030: Big Data-Part2"), course);
        String[] courseList = new String[]{"6CS000: Personal Development Skills for Computing", "6CS011: Web Development"};
        JComboBox<String> course_select = new JComboBox<>(courseList);
        course.gridx = 0;
        course.gridy = 2;
        dataPanel.add(new JComboBox<String>(courseList), course);
    ...
    private JPanel Show() {
        ...
        btnShow.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Level6_BIT_Teachers teacher=new Level6_BIT_Teachers();
