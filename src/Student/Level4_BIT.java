package Student;
import ModuleStudents.Student_BIT_lv4;
import ModuleTeachers.Level4_BIT_Teachers;
import javax.swing.*;
...
public class Level4_BIT extends JFrame {
    JMenuBar menuBar;
    JPanel dataPanel;
    JPanel buttonPanel;
    JPanel secondPanel;
    ...
    public Level4_BIT() {
        ...
        subpanel2.add(CourseLv4BIT_Sem1());
        subpanel2.add(CourseLv4BIT_Sem2());
        add(subpanel2);
    ...
    private JPanel CourseLv4BIT_Sem2() {
        dataPanel = new JPanel();
        dataPanel.setLayout(new GridBagLayout());
        dataPanel.setBorder(BorderFactory.createTitledBorder("Courses to study in Level-4/Year-1:BIT:SEM-2"));
    ...
    private JPanel CourseLv4BIT_Sem1() {
        dataPanel = new JPanel();
        dataPanel.setLayout(new GridBagLayout());
        dataPanel.setBorder(BorderFactory.createTitledBorder("Courses to study in Level-4/Year-1:BIT:SEM-1"));
    ...
    private JPanel Show() {
        ...
        btnShow.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Level4_BIT_Teachers teacher=new Level4_BIT_Teachers();
