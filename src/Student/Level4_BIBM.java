package Student;
import javax.swing.*;
import ModuleStudents.Student_BIBM_lv4;
...
public class Level4_BIBM extends JFrame {
    JMenuBar menuBar;
    JPanel dataPanel;
    JPanel buttonPanel;
    JPanel secondPanel;
    ...
    public Level4_BIBM() {
        ...
        subpanel2.add(CourseLv4BIBM_Sem1());
        subpanel2.add(CourseLv4BIBM_Sem2());
    ...
    private JPanel CourseLv4BIBM_Sem1(){
        dataPanel=new JPanel();
        dataPanel.setLayout(new GridBagLayout());
        dataPanel.setBorder(BorderFactory.createTitledBorder("Courses in Level 4/Year 1:BIBM:SEM-1"));
    ...
    private JPanel CourseLv4BIBM_Sem2(){
        dataPanel=new JPanel();
        dataPanel.setLayout(new GridBagLayout());
        dataPanel.setBorder(BorderFactory.createTitledBorder("Courses in Level 4/Year 1:BIBM:SEM-2"));
    ...
    private JPanel Show() {
        ...
        btnShow.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Level4_BIBM_Teachers teacher=new Level4_BIBM_Teachers();
