...
public class Student_BIT_lv4{

    private Connection con;

    public Student_BIT_lv4() {
        try {
    ...
    public void enroll(String firstName, String secondName, String phoneNumber, String address) {
        ...
        try {
            String enroll = "INSERT INTO bit_lv4(first_name,second_name,phone_number,address)" + "VALUES(?,?,?,?)";
    ...
    public ResultSet get() {
        ...
        try {
            String select = "SELECT * FROM bit_lv4";
