...
public class Student_BIBM_lv5{

    private Connection con;

    public Student_BIBM_lv5() {
        try {
    ...
    public void enroll(String firstName, String secondName, String phoneNumber, String address) {
        ...
        try {
            String enroll = "INSERT INTO bibm_lv5(first_name,second_name,phone_number,address)" + "VALUES(?,?,?,?)";
    ...
    public ResultSet get() {
        ...
        try {
            String select = "SELECT * FROM bibm_lv5";
