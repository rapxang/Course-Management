...
public class Student_BIBM_lv6 {

    private Connection con;

    public Student_BIBM_lv6() {
        try {
    ...
    public void enroll(String firstName, String secondName, String phoneNumber, String address) {
        ...
        try {
            String enroll = "INSERT INTO bibm_lv6(first_name,second_name,phone_number,address)" + "VALUES(?,?,?,?)";
    ...
    public ResultSet get() {
        ...
        try {
            String select = "SELECT * FROM bibm_lv6";
